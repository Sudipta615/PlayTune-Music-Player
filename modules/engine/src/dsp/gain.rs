...
impl GainProcessor {
    pub fn new() -> Self {
        Self { gain: 1.0, target_gain: 1.0, slew_rate: 0.001 }
    }
    ...
    pub fn with_ramp(initial_gain: f32, ramp_time_ms: f32, sample_rate: f32) -> Self {
        ...
        Self { gain: initial_gain, target_gain: initial_gain, slew_rate }
    }
...
impl FadeProcessor {
    ...
    pub fn fade_in_duration(&mut self, duration_secs: f32) {
        ...
        self.gain = 0.0;
        self.increment_per_sample =
            if self.total_samples > 0 { 1.0 / self.total_samples as f32 } else { 1.0 };
    ...
    /// M-PB-1: Cosine S-curve has zero derivative at t=0 and t=1, preventing clicks.
    #[inline]
