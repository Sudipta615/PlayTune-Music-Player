...
impl PartialEq for MediaKeyAction {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (
                Self::SetPosition { track_id: a1, position_us: a2 },
                Self::SetPosition { track_id: b1, position_us: b2 },
            ) => a1 == b1 && a2 == b2,
            (Self::SetVolume(a), Self::SetVolume(b)) => (a - b).abs() < 1e-3,
            (Self::SetRate(a), Self::SetRate(b)) => (a - b).abs() < 1e-3,
